...
const translations = {
  "zh-CN": {
    ...
    seoSummaryAria: "工具简介",
    guideLinksAria: "AIGC 合规指南",
    guideAll: "全部指南",
    guideAigcLabeling: "AIGC 标识指南",
    guideAiDisclosure: "AI 使用披露",
    guideC2paExif: "C2PA / EXIF 自查",
    guideXiaohongshu: "小红书 AI 内容检查",
    guideDouyin: "抖音 AI 内容检查",
    guideWechat: "微信公众号 AI 内容检查",
    guideBilibili: "B站 AI 内容检查",
    guideEcommerce: "电商 AI 商品图检查",
  ...
  en: {
    ...
    guideLinksAria: "AIGC compliance guides",
    guideAll: "All Guides",
    guideAigcLabeling: "AIGC Labeling Guide",
    guideAiDisclosure: "AI Disclosure Guide",
    guideC2paExif: "C2PA / EXIF Check",
    guideXiaohongshu: "Xiaohongshu AI Check",
    guideDouyin: "Douyin AI Check",
    guideWechat: "WeChat Official Account AI Check",
    guideBilibili: "Bilibili AI Check",
    guideEcommerce: "Ecommerce AI Product Image Check",
